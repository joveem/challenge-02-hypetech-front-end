          ...
          <div className='navbar mx-auto  my-auto sm:px-3 h-12 flex items-center w-full justify-end'>
            ...
            <div className='flex items-center ml-auto gap-2'>
              ...
              <div className='value-input-container'>
                <span className='input-header-title'>saldo</span>
                <input
                  // value='1,00'
              ...
              >
                {isDropdownOpen && (
                  <div className='dropdown-container mt-2 menu menu-compact rounded py-2 w-[280px] max-w-[300px] absolute top-[30px] right-[30px] z-10'>
