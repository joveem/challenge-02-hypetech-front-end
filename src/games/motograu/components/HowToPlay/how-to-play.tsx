...
export default function HowToPlay ({ show, toggle }: Props) {
  return (
    <Modal show={show} toggle={toggle}>
      <div className='how-to-play-moto-grau-container py-0'>
        <section
        ...
        <div className='content-container'>
          <div className='p-4 text-sm '>
            <div className='company-container grid lg:flex gap-8 align-center py-4'>
              <img
              ...
              <p className='text-xs font-semibold'>
                ...
                para uma nova geração de jogadores. Poderá ganhar
                várias vezes essa quantia em apenas alguns segundos!
                Nossos Jogos Turbo baseiam-se em uma forma que pode
                ser verificado no momento e é considerado como a única
            ...
            <hr />
            <div className='p-3'>
              <div className='tutorial-container grid lg:grid-cols-3 gap-12 mb-8'>
                ...
                <div className='image-step sm:w-[50%] md:w-[40%] lg:w-[100%]  lg:h-[200px] h-[230px] mx-auto'>
                  ...
                  <div className='description-box'>
                    <p
                      ...
                      style={{ lineHeight: '2' }}
                    >
                      Retirar antes do motoqueiro perder o equilibrio
                      e ganhar X vezes!
                    </p>
                  </div>
                </div>
              ...
              <li className='list'>
                Dito isto, não há necessidade de se limitar a apenas
                uma aposta de cada vez. Você pode fazer duas apostas
                ao mesmo tempo usando o painel de apostas esquerdo e
                direito.
              </li>
              <li className='list'>
                Para retirar os seus ganhos, precisa de clicar no
                botão
              ...
              <li className='list'>
                ...
                qualquer aposta ao clicar na aba <b>Auto</b> em cima
                do botão "Apostar". Nesse caso, as apostas são feitas
              ...
              <li className='list'>
                ...
                Para fazer isso, você deve definir no painel de
                apostas o valor de "Auto Retirar" e quantas vezes
                deseja repetir esta jogada no campo "Quantidade", e
                então, iniciar o jogo automático clicando em{' '}
                <b>"APOSTA AUTO"</b>.
              </li>
              ...
              <li className='list'>
                À esquerda (sob o quadro de apostas na interface
                móvel) existe o painel "Apostas ao vivo". Mostra as
                apostas que foram feitas na rodada atual.
              </li>
              <li className='list'>
                O painel <b>"Histórico"</b> contém informações sobre
                as apostas feitas e os levantamentos durante todo o
                tempo do jogo.
              </li>
              <li className='list'>
                O painel <b>"LANCES ANTERIORES"</b> que ha acima da
                tela do jogo contém informações sobre os últimos
                resultados que saíram durante os últimos jogos.
              </li>
